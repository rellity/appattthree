...
const AccountsScreen = ({ navigation }) => {
          ...
          <Card.Content>
            ...
            <Card.Actions>
              <View style={styles.centeredActions}>
                ...
                <Text> | </Text>
                <TouchableOpacity
                  onPress={() => navigation.navigate("AdminManagementScreen")}
                >
  ...
  useEffect(() => {
    SecureStore.getItemAsync("isLoggedIn")
      .then((storedIsLoggedIn) => {
        const isLoggedIn =
          storedIsLoggedIn === "true" || storedIsLoggedIn === true;
    ...
    if (value) {
      try {
        const response = await axios.get(
          `${check}/attappthree/getclasslist.php?value=${value}`
        );
      ...
      Alert.alert(
        ...
        [
          ...
          },
          {
            ...
            onPress: async () => {
              res = await axios.get(
                `${check}/attappthree/deletestu.php?id=${recordId}`
              );
  ...
  return (
    <View style={styles.container}>
              ...
              <View style={styles.passwordContainer}>
                ...
                >
                  ...
                  <Icon
                    ...
                    size={20}
                    color={showPassword ? "#3498db" : "black"}
                  />
                </TouchableOpacity>
              </View>
      ...
      <SettingsTab style={{ position: "absolute", bottom: 0 }} />
    </View>
  );
};

const SettingsTab = ({ navigation, style }) => {
  return (
    <View style={{ ...style }}>
